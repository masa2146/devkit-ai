...
description: Generates AI assistant configuration files for a target software project. Analyzes tech stack, creates skills, hooks, agents, and TASK.md across Claude Code, Copilot, Gemini, and Cursor platforms.
